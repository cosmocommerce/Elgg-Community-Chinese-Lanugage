 ...
 */
$chinese = array(
  'groups:group_type'=>"群组类型",
  'groupextended:type:network'=>"网络",
  'groupextended:type:organization'=>"组织",
  'groupextended:type:group'=>"群组",
  'networks:all'=>"所有的网络和群组",
  'organizations:all'=>"所有组织"
);
