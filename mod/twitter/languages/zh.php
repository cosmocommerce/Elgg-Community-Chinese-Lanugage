 ...
 */
	$chinese= array(
		...
		'twitter:username' => '输入Twitter用户名',
		'twitter:num' => '显示条目数量',
		'twitter:visit' => '访问我的twitter',
		'twitter:notset' => 'Twitter 还未设定',
	     ...
	     **/
	        ...
	        'twitter:river:created' => "%s 添加了 Twitter 插件。",
	        'twitter:river:updated' => "%s 更新了 Twitter 插件。",
	        'twitter:river:delete' => "%s 删除了 Twitter 插件。",
